...
export default function HomePage() {
  ...
  return (
    <div className="w-full flex">
      <div className="group mx-auto relative flex lg:flex-row flex-col justify-center items-center w-fit">
        <motion.div
        ...
        >
          <img
            ...
            alt="React_logo"
            draggable={false}
            className="animate-spin-slow w-[60vw] sm:w-[26rem] cursor-grabbing"
          />
        </motion.div>
        <motion.div
          ...
          style={{z: 1}}
        >
          <div className="lg:-ml-32 lg:mt-[48px]">
